...
<link rel="stylesheet" href="<?php echo e(asset('/public/css/adminpanel.css')); ?>">
<?php $__env->startSection('mainContent'); ?>
                    ...
                    <div class="row g-3 py-2">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-success text-white text-center">
                                <a href="<?php echo e(url('/student-list')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-danger text-white text-center">
                                <a href="<?php echo e(url('/fees/due-fees')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-info text-white text-center">
                                <a href="<?php echo e(url('exam')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-primary text-white text-center">
                                <a href="<?php echo e(url('/student-certificate')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-info text-white text-center">
                                <a href="<?php echo e(url('student-attendance-report')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-secondary text-white text-center">
                                <a href="<?php echo e(url('/staff-directory')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-success text-white text-center">
                                <a href="<?php echo e(url('/search-profit-by-date')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card bg-info text-white text-center">
                                <a href="<?php echo e(url('/backup-settings')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card text-white text-center" style="background-color: rgb(30, 53, 74);">
                                <a href="<?php echo e(url('all-issed-book')); ?>" class="stretched-link">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="dashboard-card text-white text-center" style="background-color: rgb(242, 153, 19);">
                                <a href="<?php echo e(url('fees/bank-payment')); ?>" class="stretched-link">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="dashboard-box blue-bg">
                    ...
                    <h4><?php echo e($y_total_income); ?></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="dashboard-box green-bg">
                    ...
                    <h4><?php echo e($m_total_income); ?></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="dashboard-box green-bg">
                    ...
                    <h4><?php echo e($m_total_income - $m_total_expense); ?></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="dashboard-box orange-bg">
                    ...
                    <h4><?php echo e($y_total_expense); ?> </h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="dashboard-box orange-bg">
                    ...
                    <h4><?php echo e($m_total_expense); ?></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="dashboard-box gray-bg">
                    ...
                    <h4><?php echo e($today_expense); ?></h4>
                    <p>Expense Today</p>
                    <a href="#">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="income-chart">
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <h6>Income</h6>
                            <p><?php echo e(generalSetting()->currency_symbol); ?> <strong id="incomeAmount"></strong></p>
                        </div>
                        <div class="col">
                            <h6>Expenses</h6>
                            <p><?php echo e(generalSetting()->currency_symbol); ?> <strong id="expenseAmount"></strong></p>
                        </div>
                        <div class="col">
                            <h6>Profit</h6>
                            <p><?php echo e(generalSetting()->currency_symbol); ?> <strong id="profitAmount"></strong></p>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="sidebar-widget green-sidebar">
                    ...
                    <p style="color: white">Present: <?php echo e($pStaff ?? '0'); ?>, Absent: <?php echo e($aStaff ?? '0'); ?>, Late:
                        <?php echo e($lStaff); ?></p>
                </div>
                <div class="sidebar-widget blue-sidebar">
                    <h6>Student Attendance Overview</h6>
                    <p style="color: white">Present: <?php echo e($pStudent ?? '0'); ?>, Absent: <?php echo e($aStudent ?? '0'); ?>, Late:
                        <?php echo e($aStudent); ?></p>
                </div>
                <div class="sidebar-widget purple-sidebar">
                    <h6>Total Students: <?php echo e($tStudent ?? '0'); ?></h6>
                    <p style="color: white">Girls: <?php echo e($tStudentF ?? '0'); ?>, Boys: <?php echo e($tStudentM ?? '0'); ?></p>
                </div>
    ...
    <script>
        ...
        function fetchChartData(type) {
            fetch(`<?php echo e(url('/income-expense-chart-data?filter=${type}')); ?>`)
                .then(res => res.json())
                .then(data => {
                    console.log(data);
