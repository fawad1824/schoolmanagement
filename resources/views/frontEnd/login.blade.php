                ...
                <div class="col-lg-5 col-md-8">
                    <div class="form-wrap text-center">
                        <div class="logo-container">
                            <a href="#">
                                <img style="height: 91px;" src="{{ asset('public/backEnd/img/logo.png') }}"
                                    alt="">
                            </a>
                        </div>
    ...
    <footer class="footer_area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <p>Copyright © 2018 All rights reserved | This application is made by <a
                            href="http://www.codepixar.com/">Codepixar</a></p>
                </div>
            </div>
        </div>
    </footer>
